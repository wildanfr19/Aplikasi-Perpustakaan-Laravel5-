...
<div class="form-group {!! $errors->has('author_id') ? 'has-error' : '' !!}">
	...
	<div class="col-md-7">
		{!! Form::select('author_id', [''=>'']+App\Author::pluck('name','id')->all(), null, ['class'=>'form-control js-selectize','placeholder' => 'Pilih Penulis']) !!}
...
<div class="form-group">
	<div class="col-md-7 col-md-offset-2">
		...
		<a href="{{ route('books.index') }}" class="btn btn-default" title="">Kembali</a>
	</div>
</div>